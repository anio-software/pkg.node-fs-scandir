...
export default {
	...
	autogenerate: {
		...
		"export/scandir.d.mts": generateFromTemplate("template/scandir.d.mts", asyncTypes),
		"export/scandirSync.d.mts": generateFromTemplate("template/scandir.d.mts", syncTypes),

		"export/scandirFactory.d.mts": generateFromTemplate("template/scandirFactory.d.mts", {
			"scandir$Sync": "scandir"
		}),
		"export/scandirSyncFactory.d.mts": generateFromTemplate("template/scandirFactory.d.mts", {
